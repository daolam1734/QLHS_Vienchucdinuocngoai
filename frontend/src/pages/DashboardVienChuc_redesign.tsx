...
import './DashboardVienChuc_redesign.css';
  ...
  const loadData = async () => {
    try {
      ...
      if (hoSoResponse.ok) {
        ...
        setAllHoSoList(hoSoData);
        setHoSoList(hoSoData.slice(0, 5));
      }
    } catch (error) {
              ...
              <>
                <div className="stats-cards">
                  <div 
                    ...
                    onClick={() => handleStatClick('MoiTao')}
                  >
                  ...
                  <div 
                    ...
                    onClick={() => handleStatClick('DangDuyet')}
                  >
                    <div className="stat-content">
                  ...
                  <div 
                    ...
                    onClick={() => handleStatClick('DaDuyet')}
                  >
                    <div className="stat-content">
                  ...
                  <div 
                    ...
                    onClick={() => handleStatClick('TuChoi')}
                  >
                    <div className="stat-content">
                  ...
                  <div className="all-hoso-section">
                    ...
                    <div className="full-hoso-list">
                      {allHoSoList.map((hoSo) => (
                        <div key={hoSo.ho_so_id} className="hoso-item">
